...
prevButtonServices.addEventListener("click", ()=>{
    currentIndex--;
    if (currentIndex < 0) currentIndex = servicesSlides.length - 1;
...
servicesSlides.forEach((slide, index)=>{
    slide.addEventListener("click", ()=>{
        for(let i = 0; i < servicesSlides.length; i++)servicesSlides[i].classList.remove("first", "second", "third", "fourth", "fifth", "thirdRight", "firstSlide", "secondSlide", "thirdSlide", "fourthSlide", "fifthSlide", "firstSlidePrev", "secondSlidePrev", "thirdSlidePrev", "fourthSlidePrev", "secondSlideNext", "thirdSlideNext", "fourthSlideNext", "fifthSlideNext");
        switch(index){
            case 0:
                for(let i = 0; i < servicesSlides.length; i++){
                    if (i === 0) {
                        ...
                        continue;
                    } else servicesSlides[i].classList.add("first");
                }
                break;
            case 1:
                for(let i = 0; i < servicesSlides.length; i++){
                    if (i === 0) {
                        ...
                        continue;
                    } else servicesSlides[i].classList.add("second");
                }
                break;
            case 2:
                for(let i = 0; i < servicesSlides.length; i++)if (i === 2) slide.classList.add("thirdSlide");
                else slide.classList.add("third");
                break;
            case 3:
                for(let i = 0; i < servicesSlides.length; i++)if (i === 3) slide.classList.add("fourthSlide");
                else slide.classList.add("fourth");
                break;
            case 4:
                for(let i = 0; i < servicesSlides.length; i++)if (i === 4) slide.classList.add("fifthSlide");
                else slide.classList.add("fifth");
                break;
            default:
                break;
        }
...
function updateServiceSlider() {
    servicesSlides.forEach((slide, index)=>{
        slide.classList.remove("first", "second", "third", "fourth", "fifth", "thirdRight", "firstSlide", "secondSlide", "thirdSlide", "fourthSlide", "fifthSlide", "firstSlidePrev", "secondSlidePrev", "thirdSlidePrev", "fourthSlidePrev", "secondSlideNext", "thirdSlideNext", "fourthSlideNext", "fifthSlideNext");
    });
    switch(currentIndex){
        case 0:
            for(let i = 0; i < servicesSlides.length; i++){
        ...
        case 2:
            for(let i = 0; i < servicesSlides.length; i++){
                if (i === 0) servicesSlides[i].classList.add("third");
                else if (i === 1) {
                    ...
                    continue;
                } else servicesSlides[i].classList.add("thirdRight");
            }
            break;
        case 3:
            for(let i = 0; i < servicesSlides.length; i++){
                if (i === 2) {
                    ...
                    continue;
                } else servicesSlides[i].classList.add("fourth");
            }
            break;
        case 4:
            for(let i = 0; i < servicesSlides.length; i++){
                if (i === 3) {
                    ...
                    continue;
                } else servicesSlides[i].classList.add("fifth");
            }
            break;
        default:
            break;
...
prevButton.addEventListener("click", ()=>{
    ...
    if (currentFeedbackIndex < 0) currentFeedbackIndex = feedbacksSlides.length - 1;
